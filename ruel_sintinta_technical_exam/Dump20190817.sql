CREATE DATABASE  IF NOT EXISTS `youtube_app` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `youtube_app`;
...
CREATE TABLE `youtube_channel_videos` (
  ...
  `thumbnails` varchar(45) DEFAULT NULL,
  `video_titles` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2019-08-17 14:50:26
